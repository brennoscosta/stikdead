...
**Fase 4 — Online:** Socket.io, servidor autoritativo rodando a mesma simulação, salas de batalha, matchmaking, desafio direto e reconexão. É quando o projeto sobe para o VPS.
