...
export default function ExcellentTip() {
  ...
  return (
    <div className="exc-tip" style={{ left, top, width: W }} onPointerDown={(e) => e.stopPropagation()}>
      <div className="exc-name">{item.name}</div>
      <div className="exc-rarity">{RARITY_LABEL[item.rarity] || item.rarity} · ITEM EXCELLENT</div>
